/* assembler_txt.c -- writes ONLY the debug listing (no hex files).
 *
 * Usage: assembler_txt program.asm
...
int main(int argc, char **argv) {
    if (argc != 2) {
        ...
        fprintf(stderr, "Assembles and writes program_listing.txt only.\n");
        return 1;
    }
